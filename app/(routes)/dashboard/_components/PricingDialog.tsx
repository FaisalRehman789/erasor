    ...
    <DialogContent className="max-w-4xl">
      <DialogHeader>
        ...
        <DialogDescription>
         ...
         bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-indigo-700 hover:ring-1 hover:ring-indigo-700 focus:outline-none focus:ring active:text-indigo-500 cursor-pointer"
                >
                  Upgrade
                </div>
              </div>
